...
import com.example.smart_mirror.BOARD.BoardRead_Activity;
import com.example.smart_mirror.BOARD.BoardWrite_Activity;
import com.example.smart_mirror.BOARD.FreeBoard_Activity;
import com.example.smart_mirror.BOARD.FreeBoard_Adapter;
import com.example.smart_mirror.BOARD.FreeBoard_AutoComplete_Request;
...
public class Board_Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        viewGroup = (ViewGroup) inflater.inflate(R.layout.board_fragment, container, false);

        intent_id = getArguments().getString("id");

        autoCompleteTextView = (AutoCompleteTextView) viewGroup.findViewById(R.id.tv_auto);
        list = new ArrayList<>();
        recyclerView = (RecyclerView) viewGroup.findViewById(R.id.recycler_FreeBoard);
        linearLayoutManager = new LinearLayoutManager(getActivity());
        recyclerView.setLayoutManager(linearLayoutManager);     // LayoutManager를 방금 생성한 recyclerView에 설정해라.

        arrayList = new ArrayList<>();

        swipeRefreshLayout = (SwipeRefreshLayout) viewGroup.findViewById(R.id.swipe_layout);
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                Board_Fragment.GetData task = new Board_Fragment.GetData();
         ...
         * 자동 완성
         */
        ArrayAdapter<String> searchList = new ArrayAdapter<String>(getActivity(), android.R.layout.simple_dropdown_item_1line, list);
                            ...
                            public void onResponse(String response) {
                                try {
                                    ...
                                    if (success) {
                                        ...
                                        Intent intent = new Intent(getActivity(), BoardRead_Activity.class);
        ...
        search_Btn = (ImageView) viewGroup.findViewById(R.id.search_Btn);
        ...
        freeBoard_writeBtn = (Button) viewGroup.findViewById(R.id.freeBoard_writeBtn);
        freeBoard_writeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), BoardWrite_Activity.class);
                intent.putExtra("id", intent_id);
                startActivity(intent);
            }
        });
