...
//            Total_score = 0;
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(v.getContext(), Detail_Result.class);

                // num % 의 문자열 중에서 숫자만 Separate 하여 숫자만 인자로 넘겨준다.
                String str = holder.recycler_ProgressRate_Score.getText().toString();
                String restr = str.replaceAll("[^0-9]","");

                intent.putExtra("Total_ProgressRate", restr);
                intent.putExtra("Dangerous", holder.recycler_Grade.getText().toString());
