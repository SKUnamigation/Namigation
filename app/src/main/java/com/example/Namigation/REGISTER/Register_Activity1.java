    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        CKid_Btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RequestQueue queue = Volley.newRequestQueue(Register_Activity1.this);
        ...
        Register_Next_Btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(id.equals("") || pw.equals("") || name.equals("") || CKpw.equals("")) {
                    dialogView = (View) View.inflate(Register_Activity1.this, R.layout.alertdialog_activity, null);

                    AlertDialog.Builder dlg = new AlertDialog.Builder(Register_Activity1.this);
                ...
                // 모든 칸이 채워지고,
                    ...
                    // 만약 중복 확인이 되었다면!
                    if (CKid_Success) {
                        Intent intent = new Intent(Register_Activity1.this, Register_Activity2.class);
